...
<div class="w3-top">
  <div class="w3-bar w3-black w3-card">
    ...
    <a href="https://github.com/Hangnail42/ccode" class="w3-bar-item button w3-padding-large w3-hide-small">C-CODE</a>
...
<!-- Footer -->
<footer class="w3-container w3-padding-64 w3-center w3-opacity w3-teal w3-hover-blue-grey w3-xlarge">
